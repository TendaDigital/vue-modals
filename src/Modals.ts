...
export default class Modals {
  ...
  static createStackInstance(name): ModalStack {
    console.warn(`[VueModals] No ModalStack was found for name "${name}". Using Modals without a stack instance causes one to be created as default at the end of the document body.`)
